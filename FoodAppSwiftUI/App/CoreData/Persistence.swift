...
struct PersistenceController {
    ...
    // MARK: Eğer değer hafızada değilse, Yummie ismi ve /dev/null container içerisine kaydediliyor.
    init(inMemory: Bool = false) {
        ...
        ///MARK: Kallıcı olaraktan hafızaya bir şeyler kaydedilirken error durumu kontrol ediliyor
        ...
        ///MARK: - Otomatik olaraktan değişiklikleri birleştiriyor.
